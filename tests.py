...
class ApiTest(unittest.TestCase):
    ...
    def test_organization_issues(self):
        ...
        self.assertTrue('Civic Issue 1.1' in [item['title'] for item in response['objects']])
    ...
    def test_org_issues_filtered_by_label(self):
        ...
        issue13 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.1')
        issue14 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.2')
        issue15 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.3')
        issue16 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.4')
        issue17 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.5')
        issue18 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.6')
        issue19 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.7')
        issue20 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.8')
        issue21 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.9')
        issue22 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.10')
        issue23 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.11')
        issue24 = IssueFactory(project_id=project1.id, title=u'Civic Issue 1.12')
        db.session.flush()
